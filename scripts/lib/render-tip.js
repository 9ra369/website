...
const SITE_HEADER = (depth) => {
  ...
  <div class="container">
    ...
    <nav class="main-nav">
      ...
      <a href="${p}guides/environment.html">背景制作まとめ</a>
  ...
  <div class="container">
    <div class="footer-grid">
      <div class="footer-brand">
        ...
        <p class="footer-disclaimer-note">本サイトはHoudini・Blender・Maya等、記事内で言及する各社製品・サービスとは一切関係のない、個人が運営する非公式サイトです。</p>
      </div>
      ...
      <div class="footer-col">
        ...
        <ul>
          ...
          <li><a href="https://kurama-personal-website.netlify.app/" target="_blank" rel="noopener">Portfolio</a></li>
        </ul>
      </div>
    </div>
...
function renderTipPage(mdPath, allPosts = []) {
  ...
  // accept an array too. An array item may also be {url, label} to show a
  // custom label (e.g. an artist + artwork title) instead of the generic
  // "URL" — used for daily-analysis posts citing a specific artwork, and for
